...
#'}
#' @export
autoencoder4pseudoBulkGPU <- function(group=c("sudo","docker"), scratch.folder, file,separator,cloutput,separator,perplexity,n_iter,n_neighbors,min_dist,tsneplot,umapplot){
    ...
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -d repbioinfo/densevisualprojection python3 /home/main.py ",matrixNameC,".",format," ",cloutput," ",separator," ",perplexity," ",n_iter," ",n_neighbors," ",min_dist," ",seed," ",tsneplot," ",umapplot,sep="")
